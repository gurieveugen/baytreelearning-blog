...
<head>
    ...
    <script type='text/javascript'>
		...
		jQuery(function($) {
			$('#mcTagMap ul li a:contains("Parent/Family Communication")').widthTruncate({width:71});

			if ($('.holdleft').is(':empty')){
				$(this).hide();
			}
		});
    </script>
		...
		<div class="main-navigation">
    		...
    		<div id="primary-nav">
    		    ...
    		    <?php if( has_nav_menu( 'primary-menu' ) ) {
    		        ...
    		        wp_nav_menu( array( 'theme_location' => 'primary-menu', 'container' => '', 'menu_id' => 'primary-menu' ) ); 
